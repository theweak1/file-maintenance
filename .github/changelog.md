...
If this file is present at release time and was updated in this release commit,
its contents will be used as the release notes. Otherwise the workflow will fall
back to the default automated note.
